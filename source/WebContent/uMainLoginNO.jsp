...
<!-- Mirrored from www.bikeseoul.com/main.do by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 10:54:06 GMT -->
        ...
        <div class="header">
            ...
            <div class="menu_web">
                <ul>
                    ...
                    <li><a href="uLogin.bo">이용권 구매</a></li>
     ...
     <!--범례-->
	    ...
	    <div class="container" id="main">
	    	...
	    	<!-- 2019.02.20 id추가 -->
	    		...
	    		<p>로그인 후 편리하게 이용하세요.<a href="login.html">회원 로그인</a></p>
					</div>
	        </div>
			...
			<div class="main_tab">
				<ul>
					<li class="mt_1"><a href="app/use/moveUseMenuRentCpn.html">대여방법</a></li>
					<li class="mt_2"><a href="info/infoDuty.html">반납방법</a></li>
					<li class="mt_3"><a href="app/station/moveStationRealtimeStatus.html">대여소현황</a></li>
					<li class="mt_4"><a href="login.html">대여하기</a></li>
				</ul>
			</div>
    ...
    <div class="bottom">
        <dl>
            <dd class="my">
            	...
            	<a href="leftPage.html"></a>

            </dd>
            <dd class="bookmark"><a href="login.html"></a></dd>
            <dt class="guide"><a href="info/infoReg.html"></a></dt>
            <dd class="qr"><a href="javascript:goQrRent();" id="qr"></a></dd>
            <dd class="ticket"><a href="login.html"></a></dd>
        </dl>
...
<script type="text/javascript" src="../openapi.map.naver.com/openapi/v3/maps98a9.js?ncpClientId=4brj1w2qf8&amp;submodules=geocoder"></script>
			...
			$.ajax({
				...
				success		: function(data){
		 			if(data.resultMessage == 'Success'){
						location.href = "memberReconsent.html";
					}
				},
...
<!-- Mirrored from www.bikeseoul.com/main.do by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 10:54:07 GMT -->
</html>
