...
<!-- Mirrored from www.bikeseoul.com/memberIdFind.do by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 10:54:16 GMT -->
...
<![endif]-->
<script src="js/repond.min.html"></script>
...
<div class="wrap login">
    ...
    <div class="header_wrap">
        <div class="header">
            ...
            <div class="logo"><a href="uMainLogin.bo"><img src="images/logo.png" alt="서울자전거 따릉이"></a></div>
    ...
    <!--웹 : 헤더추가--><div class="container">
        ...
        <div class="login">
            ...
            <h2 id="sendMobText"><br/></h2>

            <div class="btn" id="memberSmsAuth"><a href="#">아이디 찾기</a></div>
	...
	<script type="text/javascript">
		...
		findId.init = function() {
			...
			$("#memberSmsAuth").on('click', this.memberSmsAuth);
		...
		findId.memberSmsSend = function(){
			chgMobNo = false;
			clearTimeout(timerID);
			if(findId.chkValidation()){
				...
				commonAjax.postAjax("/memberSmsSendAjax.do", "json", $("#searchFrm").serialize()
						,function(data){
							...
							if(result != ""){
								...
								findId.countdown('countdown', 5); //minute base
								chkTimeout = true;
		...
		findId.chkValidation = function(){ //휴대폰 정보가 입력됐는지 확인
		...
		findId.countdown = function(elementId, min){
		...
		findId.memberSmsAuth = function(){
			...
			//$("#searchFrm").attr({method : "post", action : "/findIdEnd.do"}).submit();
			findId.idFind(mob);

		}

		findId.idFind = function(userMob) {
			if(doubleSubmitCheck()) return ;
			commonAjax.postAjax("/idFindAjax.do", 'json', {userMob:userMob}
		    , function(data){
		    	if(data.resultMessage == 'Success'){
		    		$("#userId").val(data.memberVo.userId);
		    		$("#searchFrm").attr({method : "post", action : "/popIdFindEnd.do"}).submit();
				}else{
					alert("해당하는 정보가 없습니다.");
				}
			}
...
<!-- Mirrored from www.bikeseoul.com/memberIdFind.do by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 10:54:17 GMT -->
</html>
